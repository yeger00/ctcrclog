...
g++-9 -c -std=c++2a $FLAGS program1.cpp -O3 -o program1.o
g++-9 -c -std=c++2a $FLAGS program2.cpp -O3 -o program2.o
g++-9 -std=c++2a $FLAGS main.cpp -O3 program1.o program2.o -o main-debug
red "running:"
./main-debug
echo
...
g++-9 -c -std=c++2a $FLAGS program1.cpp -O3 -o program1.o
g++-9 -c -std=c++2a $FLAGS program2.cpp -O3 -o program2.o
g++-9 -std=c++2a $FLAGS crc_to_string.cpp -O3 program1.o program2.o -o crc_to_string
...
g++-9 -c -std=c++2a $FLAGS program1.cpp -O3 -o program1.o
g++-9 -c -std=c++2a $FLAGS program2.cpp -O3 -o program2.o
g++-9 -std=c++2a $FLAGS main.cpp -O3 program1.o program2.o -o main-release
strip main-release
./main-release
echo
